...
export function createInlineScript(sprite: string, insertPosition: "first" | "last" = "first"): string {
...
export function createIIFEScript(sprite: string, insertPosition: "first" | "last" = "first"): string {
  const insertCode = insertPosition === "last" 
    ? "document.body.appendChild(container);"
    : "document.body.insertBefore(container, document.body.firstChild);";
